...
bool Quad::intersect(const Line& l, Point& result) {
	...
	float secondq = 2 * A * l.start.x * l.u.x + 2 * B * l.start.y * l.u.y + 2 * C * l.start.z * l.u.z
		...
		+ H * l.u.y 
		+ I * l.u.z;
	float thirdq = A * l.start.x * l.start.x 
		+ B * l.start.y * l.start.y 
		+ C * l.start.z * l.start.z
		+ D * l.start.x * l.start.y 
		+ E * l.start.x * l.start.z 
		+ F * l.start.y * l.start.z
		+ G * l.start.x 
		+ H * l.start.y 
		+ I * l.start.z + J;
